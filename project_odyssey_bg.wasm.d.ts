...
export function closure1556_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h756498790c918cf5(a: number, b: number): void;
export function closure6379_externref_shim(a: number, b: number, c: number, d: number): void;
